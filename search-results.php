...
// Build SQL query
$sql = "SELECT * FROM universities WHERE country_code = 'BD'";
if ($searchByGPA && $gpa) {
    $sql .= " AND gpa_cgpa <= ?";
}
...
<head>
    ...
    body {
        ...
        font-family: 'Montserrat', sans-serif; /* Montserrat applied universally */
        margin: 0;
        padding: 0;
        color: #fff;
    }
    ...
    .feature-card {
        ...
        padding: 30px;
        color: #333;
        font-family: 'Montserrat', sans-serif; /* Ensure font applied */
    ...
    .grid-item {
        ...
        padding: 20px;
        color: #333;
        font-family: 'Montserrat', sans-serif; /* Explicit font family for grid items */
    }
    .grid-item h5 {
        margin-top: 0;
...
<body>
    <div class='container'>
        <header class='search-header'>
            ...
            <a href='local-search.html' class='btn btn-secondary'>Back to Search</a>
        </header>
";
